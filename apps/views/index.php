...
<div class="panel" id="news_panel">
    <?php $can_manage_news = app()->site->getCurUser()->isPrivilege('manage_news'); ?>
...
<div class="panel" id="links_panel">
    <div class="panel-heading">
        Links
        <?php if (app()->site->getCurUser()->isPrivilege('apply_for_links')): ?>
        - [<a href="/links/apply" target="_blank">Apply for Links</a>]
        <?php endif; ?>
        <?php if (app()->site->getCurUser()->isPrivilege('manage_links')): ?>
