                ...
                <div class="" id="subs_list">
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tr>
                            ...
                            <td class="text-center"><span class="nowrap"><?= $this->insert('helper/username', ['user' => container()->get(\App\Entity\User\UserFactory::class)->getUserById($datum['uppd_by']), 'hide' => $datum['anonymous']]) ?></span>
                            </td>
