...
<div class="comments">
    <?php if ($torrent->getComments()): ?>
        <section class="comments-list">
            <?php foreach ($comments as $commit): ?>
                <?php
                $commit_user = container()->get(\App\Entity\User\UserFactory::class)->getUserById($commit['owner_id']);
    ...
    <footer>
        <div class="reply-form" id="commentReplyForm1">
            ...
            <form class="form" method="post" action="/torrents/comments?id=<?= $torrent->getId() ?>">
                <!-- FIXME commit point -->
