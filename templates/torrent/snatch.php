            ...
            <div class="panel-body" id="torrent_snatched_details_body">
                <div id="torrent_snatched_details">
                    ...
                    <table class="table table-hover table-condensed">
                        ...
                        <tr>
                            <td><?= $this->insert('helper/username', ['user' => \Rid\Helpers\ContainerHelper::getContainer()->get('site')->getUser($snatchDetail['user_id'])]) ?></td> <!-- TODO hide username when user has Strong Privacy  -->
