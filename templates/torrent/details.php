        ...
        <div class="panel" id="torrent_action_panel">
            ...
            <div class="panel-body" id="torrent_action">
                ...
                <div class="torrent-action-item">
                    <a class="torrent-favour" href="javascript:" data-tid="<?= $torrent->getId() ?>"><i class="<?= \Rid\Helpers\ContainerHelper::getContainer()->get('auth')->getCurUser()->inBookmarkList($torrent->getId()) ? 'fas' : 'far' ?> fa-star fa-fw"></i>&nbsp;Add to Favour</a>
                </div><!-- Add to Favour -->
                <div class="torrent-action-item">
